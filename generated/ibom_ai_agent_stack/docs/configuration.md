...
|----------|---------|-------------|
| `PROJECT_NAME` | `ibom_ai_agent_stack` | Display name for the project |
...
| `TIMEZONE` | `Europe/London` | IANA timezone (e.g. `UTC`, `Europe/Warsaw`, `America/New_York`) |
...
| `POSTGRES_DB` | `ibom_ai_agent_stack` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ibom_ai_agent_stack` | Service name in Logfire dashboard |
...
| `S3_BUCKET` | `ibom_ai_agent_stack` | Bucket name |
