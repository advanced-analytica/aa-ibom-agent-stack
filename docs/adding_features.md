...
Run with: `uv run ibom_ai_agent_stack cmd my-command --name test`
...
# Or use CLI
uv run ibom_ai_agent_stack db migrate -m "Add notifications table"
uv run ibom_ai_agent_stack db upgrade
```
