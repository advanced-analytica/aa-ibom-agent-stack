---
name: review-changes
description: Review staged and unstaged code changes against this project's backend conventions. Use when asked for a code review, implementation review, or project-convention review.
---
