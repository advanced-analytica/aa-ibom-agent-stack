---
name: add-endpoint
description: Scaffold a new API endpoint with the project's schema, model, repository, service, dependency-injection, route, migration, and test layers. Use when asked to add a backend CRUD/API endpoint.
---

# Add Endpoint

Create a new API endpoint from the user's requested entity or endpoint details.
