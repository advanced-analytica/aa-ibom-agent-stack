...
Reference for `ibom_ai_agent_stack` runtime configuration. The
...
|---|---|---|---|
| `PROJECT_NAME` | optional | `ibom_ai_agent_stack` | Used in logs, OpenAPI title, email templates |
...
| `TIMEZONE` | optional | `Europe/London` | IANA TZ name (e.g. `Europe/Warsaw`) |
